...
# ===================================================================
# THIS IS YOUR "BLUFF" FUNCTION
# ===================================================================
def create_time_array(x_coords, axis_info):
    """
    Create a "bluffed" 24-hour time array ending at 7 PM,
    based on the user's request.
    """
    print("✓ Using 'bluffed' 24-hour time range (7 PM to 7 PM).")
    
    # Set the end time to 7 PM today (19:00)
    end_time = datetime.now().replace(hour=19, minute=0, second=0, microsecond=0)
    
    # Set the start time to 24 hours ago (7 PM yesterday)
    start_time = end_time - timedelta(days=1)
    
    print(f"Time range: {start_time.strftime('%I:%M %p, %b %d')} to {end_time.strftime('%I:%M %p, %b %d')}")
    
    # Linear interpolation
    total_duration = (end_time - start_time).total_seconds() # 86400 seconds
...
# ===================================================================
# END OF "BLUFF" FUNCTION
# ===================================================================

# ===================================================================
# THIS IS THE WORKING Y-AXIS FUNCTION
# ===================================================================
def create_memory_array(y_coords, axis_info):
    ...
    return memory
# ===================================================================
# END OF WORKING Y-AXIS FUNCTION
# ===================================================================
...
def plot_memory_graphs(html_file):
    ...
    axis_info = extract_axis_info(soup) # This uses the *correct* extractor
    ...
    time_array = create_time_array(x_coords, axis_info) # This uses your "bluff"
    memory_array = create_memory_array(y_coords, axis_info) # This uses the working "int()" grouping
